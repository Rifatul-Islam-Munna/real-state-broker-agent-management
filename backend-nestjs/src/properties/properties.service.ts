...
export class PropertiesService {
  ...
  private async mapProperty(property: Property, includePrivate = false) {
    ...
    return {
      ...
      minimumCreditScore: property.minimumCreditScore ?? null,
      minimumMonthlyIncome: property.minimumMonthlyIncome ?? null,
      securityDeposit: property.securityDeposit ?? null,
      applicationFee: property.applicationFee ?? null,
  ...
  private async normalizeDto(dto: any) {
    ...
    return {
      ...
      minimumCreditScore: Number.isFinite(Number(dto.minimumCreditScore)) && Number(dto.minimumCreditScore) > 0 ? Math.round(Number(dto.minimumCreditScore)) : null,
      minimumMonthlyIncome: Number.isFinite(Number(dto.minimumMonthlyIncome)) && Number(dto.minimumMonthlyIncome) > 0 ? Number(dto.minimumMonthlyIncome) : null,
      securityDeposit: Number.isFinite(Number(dto.securityDeposit)) && Number(dto.securityDeposit) >= 0 ? Number(dto.securityDeposit) : null,
      applicationFee: Number.isFinite(Number(dto.applicationFee)) && Number(dto.applicationFee) >= 0 ? Number(dto.applicationFee) : null,
      availableFrom: text(dto.availableFrom).trim() || null,
      minimumLeaseMonths: Number.isFinite(Number(dto.minimumLeaseMonths)) && Number(dto.minimumLeaseMonths) > 0 ? Math.round(Number(dto.minimumLeaseMonths)) : null,
      applicationInstructions: text(dto.applicationInstructions).trim(),
      realtorShowingInstructions: text(dto.realtorShowingInstructions).trim(),
