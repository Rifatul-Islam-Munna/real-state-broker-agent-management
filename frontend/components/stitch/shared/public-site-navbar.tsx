    ...
    <header className="border-b border-primary/10 bg-white px-4 py-4 md:px-20">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        <div className="flex items-center gap-8">
          <Link aria-label={agencyName || "Home"} href="/" className="flex items-center gap-2 text-primary">
            {logoUrl ? (
              <img alt={agencyName || "Agency logo"} className="h-10 w-auto max-w-28 object-contain" src={logoUrl} />
            ) : null}
            {agencyName ? (
