...
function mapPropertyToFormValues(property: PropertyItem): PropertyFormValues {
  return {
    ...
    internalDetailsMarkdown: property.internalDetailsMarkdown ?? "",
...
function buildPropertyPayload(
  ...
  const payload: PropertySaveInput = {
    ...
    ownerCompany: values.ownerCompany?.trim() || null,
    ownerEmail: values.ownerEmail?.trim() ?? "",
    ownerName: values.ownerName?.trim() ?? "",
    ownerNotes: values.ownerNotes?.trim() || null,
    internalDetailsMarkdown: values.internalDetailsMarkdown?.trim() || null,
