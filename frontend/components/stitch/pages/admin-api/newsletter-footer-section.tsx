        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a className="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-accent transition-colors" href="#">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-white/70">
              <li><a className="hover:text-white transition-colors" href="#">{"New York City"}</a></li>
              <li><a className="hover:text-white transition-colors" href="#">{"Beverly Hills"}</a></li>
              <li><a className="hover:text-white transition-colors" href="#">{"Miami Shores"}</a></li>
              <li><a className="hover:text-white transition-colors" href="#">{"San Francisco"}</a></li>
              <li><a className="hover:text-white transition-colors" href="#">{"London West"}</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-black uppercase text-xs tracking-[0.2em] mb-8 text-accent">
