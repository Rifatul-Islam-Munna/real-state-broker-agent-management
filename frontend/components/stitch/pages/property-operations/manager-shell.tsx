...
export function ManagerShell({ children, loading, refresh, tab, setTab }: { children: ReactNode; loading: boolean; refresh: () => void; tab: OperationsTab; setTab: (tab: OperationsTab) => void }) {
