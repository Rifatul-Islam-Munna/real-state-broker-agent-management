...
export function Section1Section() {
  const contactRequests = useAdminFlowStore((state) => state.contactRequests)
  const convertContactRequestToLead = useAdminFlowStore((state) => state.convertContactRequestToLead)
              ...
              <div className="flex flex-wrap gap-2 xl:justify-end">
                {item.leadId ? (
                  ...
                  <button
                    ...
                    onClick={() => convertContactRequestToLead(item.id)}
                    type="button"
                  >
                    {"Convert To Lead"}
                  </button>
